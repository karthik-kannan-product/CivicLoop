...
const auditLabel = { credential_replaced: "Credential replaced", configuration_changed: "Configuration changed", connection_tested: "Connection tested", connection_disabled: "Connection disabled", audit_listed: "Audit history viewed" };
